...
--
-- Host: localhost
-- Erstellungszeit: 30. Jan 2021 um 19:35
...
INSERT INTO `admins` (`id`, `firstname`, `surname`, `email`, `password`, `language_code`) VALUES
(1, 'Sebastian', 'Wulf', 'sebastian2@wulf.email', '$2y$10$.MhC3z2IAtmMN8z42yV61uSQqs1T5uwb/.c8bgxHBSkN8Qg3Ep4hm', 1);
...
INSERT INTO `customers` (`id`, `salutation_id`, `customerType_id`, `company`, `address`, `zip`, `location`, `country_code`, `firstname`, `surname`, `mobile`, `phone`, `fax`, `mail`, `homepage`, `loginActive`, `newsletter`, `customerToken`, `hash`) VALUES
(1, 0, 0, '', '', '', '', '', '', '', '', '', '', '', '', 0, 0, '', '$2y$07$BCryptRequires22Chrcte/VlQH0piJtjXl.0t1XkA8pw9dMXTpOq'),
(2, 1, 1, '{$company}', '{$address}', '{$zip}', '{$location}', 'DE', '{$firstname}', '{$surname}', '{$mobile}', '{$phone}', '{$fax}', '{$mail}', '{$homepage}', 1, 1, '{$customerToken}', NULL),
